...
print('\n=====================AND===================')
hasil = not (a and a)
print(a,'nad',a,'adalah =',hasil)
hasil = not (a and b)
print(a,'nad',b,'adalah =',hasil)
hasil = not (b and a)
print(b,'nad',a,'adalah =',hasil)
hasil = not (b and b)
...
test = 'da' #isi dengan nama 2 huruf ada di nama
cek = test in nama 
print(test,'ada di',nama,'adalah',cek)

test = 'ad' #isi dengan nama 2 huruf ada di nama
cek = test in nama 
print(test,'ada di',nama,'adalah',cek)
